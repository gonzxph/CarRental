<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        $pickup = $_POST["pickupinput"] ?? '';
        $dropoff = $_POST["dropoffinput"] ?? '';
        $date_time = $_POST["dateTimeInput"] ?? '';
    ...
    <div class="container mt-5 vh-100">
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="card">
                    <div class="card-title">
                        <h5 class="card-title-text">Search and Filter</h5>
                    </div>
                    <div class="card-body">
                        <form id="bookingForm" action="index.php" method="POST">
                            <div class="input-group mb-3">
                                ...
                                <input readonly id="pickupInput" name="pickupinput" type="text" data-bs-toggle="modal" data-bs-target="#pickupModal" class="form-control" placeholder="Choose pick up location" value="<?php echo $pickup?>">
                            </div>
                            <div class="input-group mb-3">
            ...
            <div class="col-lg-8 col-md-8">
                <p>Sample car list based on date available</p>
            </div>
        </div>
    </div>
